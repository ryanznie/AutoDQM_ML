...
def main():
  ...
  axs[0].annotate("Aggregate MHF-ROC curve", xy=(0.05, 0.95), xycoords='axes fraction', xytext=(10, -10), textcoords='offset points', ha='left', va='top', fontsize=12, weight='bold')
  axs[0].axis(xmin=0,xmax=15,ymin=0,ymax=60)
  axs[0].legend(loc='lower right')

  plt.savefig("./merged_ROC_MHF_FRF.pdf",bbox_inches='tight')
  print("SAVED: ./merged_ROC_MHF_FRF.pdf")
